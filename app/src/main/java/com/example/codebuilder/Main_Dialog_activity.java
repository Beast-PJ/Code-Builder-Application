...
public class Main_Dialog_activity extends AppCompatDialogFragment {
    private static com.example.codebuilder.Main_Dialog_activity.ExampleDialogListener listener;
    EditText vname;
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            listener =(com.example.codebuilder.Main_Dialog_activity.ExampleDialogListener) context;
